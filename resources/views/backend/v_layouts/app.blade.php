    ...
    <div class="page-wrapper">
        ...
        <header class="header">
            ...
            <div class="flexbox flex-1">
                ...
                <ul class="nav navbar-toolbar">
                    <li class="dropdown dropdown-inbox" data-toggle="tooltip" data-original-title="Surat Masuk">
                    ...
                    <li class="dropdown dropdown-notification" data-toggle="tooltip" data-original-title="Notifikasi">
            ...
            <div id="sidebar-collapse">
                <div class="admin-block d-flex">
                    ...
                    <div class="admin-info">
                        <div class="font-strong">{{ Auth::user()->name }}</div><small class="text-white">Administrator</small></div>
                </div>
                <ul class="side-menu metismenu">
                    ...
                    <li>
                        <a href="{{ route('user.index') }}" class="text-white"><i class="sidebar-item-icon fa fa-user"></i>
                        <span class="nav-label"> User</span></a>
                    </li>
                    {{-- <li>
                        <a href="{{ route('akun.index') }}" class="text-white"><i class="sidebar-item-icon fa fa-bank"></i>
                        <span class="nav-label"> Akun</span></a>
                    </li> --}}
                    <li>
                        <a href="{{ route('karyawan.index') }}" class="text-white"><i class="sidebar-item-icon fa fa-users"></i>
                        <span class="nav-label"> Data Karyawan</span></a>
                    </li>
                    <li>
                        <a href="{{ route('jabatan.index') }}" class="text-white"><i class="sidebar-item-icon fa fa-briefcase"></i>
                        <span class="nav-label"> Jabatan</span></a>
                    </li>
                    <li>
                        <a href="{{ route('absensi.index') }}" class="text-white"><i class="sidebar-item-icon fa fa-briefcase"></i>
                        <span class="nav-label"> Absensi</span></a>
                    </li>
                    <li>
                        <a href="{{ route('master_gaji.index') }}" class="text-white"><i class="sidebar-item-icon fa fa-briefcase"></i>
                    ...
                    {{-- <li>
                        ...
                        <ul class="nav-2-level collapse bg-teal">
                            <li>
                                <a href="#" class="text-white"> <i class="sidebar-item-icon fa fa-arrow-right"></i>Akun</a>
                            </li>
                            <li>
                                <a href="#" class="text-white"><i class="sidebar-item-icon fa fa-arrow-right"></i>Jabatan</a>
                            </li>
                        </ul>
                    </li>  --}}
                    <li>
