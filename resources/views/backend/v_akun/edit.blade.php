    ...
    <div class="ibox">
        ...
        <div class="ibox-body">
            <form action="{{ route('akun.update', $akun->id) }}" method="POST">
                ...
                <input type="text" name="kd_akun" value="{{ $akun->kd_akun }}"
                    class="form-control @error('kd_akun') is-invalid @enderror" id="">
                @error('kd_akun')
                ...
                <input type="text" name="nama_akun" value="{{ $akun->nama_akun }}"
                    class="form-control @error('nama_akun') is-invalid @enderror" id="">
                @error('nama_akun')
                <span class="invalid-feedback alert-danger" role="alert">
                    {{ $message }}
                </span>
